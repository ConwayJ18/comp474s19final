...
public class AdvancedControls implements Graphics
{
	...
	private void initializeParts(TimerImpl t, ScoreboardImpl s, TeamImpl t1, TeamImpl t2)
	{
	    ...
	    //Create Team 1 boxes
	    teamName1 = new QTextField("Team 1", 8, 25, 275, 575, 50);
	    editTeamName1 = new QButton("Edit", 4, 605, 275, 95, 50);
	    team1player1=new QTextField("Player 1", 8, 25, 335, 375, 50);
	    ...
	    team1player2=new QTextField("Player 2", 8, 25, 390, 375, 50);
	    ...
	    team1player3=new QTextField("Player 3", 8, 25, 445, 375, 50);
	    ...
	    team1player4=new QTextField("Player 4", 8, 25, 500, 375, 50);
	    ...
	    team1player5=new QTextField("Player 5", 8, 25, 555, 375, 50);
	    ...
	    team1player6=new QTextField("Player 6", 8, 25, 610, 375, 50);
	    ...
	    team1player7=new QTextField("Player 7", 8, 25, 665, 375, 50);
	    ...
	    //Create Team 2 boxes
	    teamName2 = new QTextField("Team 2", 8, 750, 275, 575, 50);
	    editTeamName2 = new QButton("Edit", 4, 1330, 275, 95, 50);
	    team2player1=new QTextField("Player 1", 8, 750, 335, 375, 50);
	    ...
	    team2player2=new QTextField("Player 2", 8, 750, 390, 375, 50);
	    ...
	    team2player3=new QTextField("Player 3", 8, 750, 445, 375, 50);
	    ...
	    team2player4=new QTextField("Player 4", 8, 750, 500, 375, 50);
	    ...
	    team2player5=new QTextField("Player 5", 8, 750, 555, 375, 50);
	    ...
	    team2player6=new QTextField("Player 6", 8, 750, 610, 375, 50);
	    ...
	    team2player7=new QTextField("Player 7", 8, 750, 665, 375, 50);
